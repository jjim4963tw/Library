...
import com.jjim4963tw.library.utility.AccessLogUtility
...
class InAppBillingManager(val context: Context) {
    companion object {
        val TAG: String? = InAppBillingManager::class.simpleName
